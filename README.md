...
- **Programming Languages:** Proficient in **JavaScript**, **HTML**, and **CSS**.
- **Frameworks:** Experienced with **React**, **Vue.js**, and **WordPress**.
- **Tools:** Skilled in **Adobe Photoshop**, **Premiere Pro**, **After Effects**, and **Blender**.
- **VR/AR Technologies:** Knowledgeable in **Unity** and **Unreal Engine**.
...
I’m open to new opportunities, collaborations, or simply discussing ideas. Feel free to contact me through the following channels:
